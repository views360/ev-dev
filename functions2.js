...
function calculateRangeHtml(inputs, mainInitialRange) {
    ...
    if (inputs.additionalJourneys.length > 0) {
        if (paygSubtitle) paygSubtitle.textContent = `Here is the key information for your journeys if you choose PAYG. Note: some calculations may generate a rounding error of +/- 1 mile or 1 minute.`;
        ...
        if (paygSubtitle) paygSubtitle.textContent = `Here is the key information for your journey if you choose PAYG. Note: some calculations may generate a rounding error of +/- 1 mile or 1 minute.`;
