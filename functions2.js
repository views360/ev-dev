...
function updateConclusionsAndItineraryUI(inputs, providers, publicKwh, totalAdhocCost, conclusionsBox) {
    ...
    const extraNote = `<p style="font-size:0.85rem; margin:0; opacity:0.8; color:var(--neon-green) !important;">IMPORTANT NOTE: Before purchasing a subscription, check that your chosen provider has charging stations in your planned area of travel — else your subscription will be wasted. Download the essential charging-location maps from the <a href="apps.html" style="color:var(--neon-green) !important;">Apps page</a>. If the cheapest provider isn't available in your area of travel, check the next cheapest and so on.</p>`;
